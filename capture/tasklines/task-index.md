...
| `myth-td-prototype/immersion` | myth-td 沉浸感迭代 | `in_progress` | `P1` | `myth-td-prototype` | `待创建` | `apps/game_demo/myth-td-prototype/CCOS` |
| `game-service/bootstrap` | game_service CCOS 联邦接入 | `done` | `P1` | `game_service` | `task-game-service-federation-migration.md` | `game_service/CCOS` |
| `ccos/hub/unification-migration-20260303` | CCOS 中枢全量迁移与文档同步 | `done` | `P0` | `ccos` | `task-ccos-hub-unification-migration-20260303.md` | `ccos/CCOS` |

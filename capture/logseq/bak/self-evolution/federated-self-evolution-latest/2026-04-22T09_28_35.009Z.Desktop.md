...
- generated_at: `2026-04-22 17:28:01 +0800`
- mode: `federated`
...
| `rule-promotion` | 澄清事项升格为规则或公理 | 39 | 1 | `rule` | `AGENTS.md / CCOS/protocol/p0-rules.md / review ledger` |
...
1. `review-ledger-promotion` -> review ledger + reviewer module + verify checks
   ...
   - current_evidence: 41 matched lines across 2 project(s)
...
| `void` | `/Users/zhuxiaowei/apps/void/CCOS/context/task-void-ai-dev-harness-mobile-rpa-pilot.md` | `69` | `物理隔离` | 4. 产品主线与研发模式文档必须持续物理隔离。 |
...
| `void` | `/Users/zhuxiaowei/apps/void/CCOS/knowledge/architecture/ai-dev-harness/ai-dev-harness-self-evolution-v1.md` | `170` | `顶层规则` | 1. 自动改写顶层规则 |
...
_Truncated: showing 12 of 39 matched lines._

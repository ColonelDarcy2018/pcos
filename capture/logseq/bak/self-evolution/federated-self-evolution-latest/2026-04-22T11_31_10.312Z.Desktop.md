...
- generated_at: `2026-04-22 17:28:32 +0800`
- mode: `federated`
...
| --- | --- | --- | --- | --- | --- |
| `workflow-stage-template` | 软件工程阶段模板 | 135 | 2 | `workflow-pack` | `scenario workflow packs: clarify -> PRD -> design -> build -> verify -> release` |
| `automation-heartbeat` | 持续推进 / 自动唤醒 / heartbeat | 51 | 2 | `workflow` | `Workflow V2 + Codex thread automation` |
| `review-ledger-promotion` | 自动审查 / review ledger / 规则候选 | 38 | 2 | `review` | `review ledger + reviewer module + verify checks` |
| `rule-promotion` | 澄清事项升格为规则或公理 | 37 | 1 | `rule` | `AGENTS.md / CCOS/protocol/p0-rules.md / review ledger` |
| `skill-promotion` | 重复需求沉淀为技能 | 14 | 2 | `skill` | `~/.codex/skills + requirement-pool state update` |
| `known-solution-research` | 已知方案 / 开源项目 / 成熟产品调研前置 | 3 | 1 | `skill` | `global skill: solution-landscape-research` |
...
| `void` | `/Users/zhuxiaowei/apps/void/CCOS/knowledge/architecture/ai-dev-harness/mobile-rpa-ai-harness-engineering-pilot-v1.md` | `423` | `里程碑` | - 只在 blocker、里程碑、规则升格和高风险动作上介入 |
| `void` | `/Users/zhuxiaowei/apps/void/CCOS/knowledge/architecture/ai-dev-harness/mobile-rpa-ai-harness-engineering-pilot-v1.md` | `436` | `里程碑` | 对“能否不间断一直运行，只在阻塞、无任务或里程碑时停止”这个问题，结论是： |
| `void` | `/Users/zhuxiaowei/apps/void/CCOS/knowledge/architecture/ai-dev-harness/mobile-rpa-ai-harness-engineering-pilot-v1.md` | `452` | `验收` | - 进入里程碑验收 |

_Truncated: showing 12 of 135 matched lines._
...
| `void` | `/Users/zhuxiaowei/apps/void/CCOS/knowledge/architecture/ai-dev-harness/mobile-rpa-ai-harness-engineering-pilot-v1.md` | `27` | `controller loop` | \| V1.1 \| 2026-04-21 \| 增补自动审查、公理规则升格、自进化记忆、Codex 并行协作工作群、连续运行 controller loop、`Hermes-agent` 借鉴边界与 `rpa-mobile` 现有设计映射 \| |
| `void` | `/Users/zhuxiaowei/apps/void/CCOS/knowledge/architecture/ai-dev-harness/mobile-rpa-ai-harness-engineering-pilot-v1.md` | `51` | `automation` | 6. **并行协作可以做，但前提是显式编排。** `Codex` 能支撑并行 agent / worktree / recurring automation，但不会默认替你组织成稳定工作群；这部分必须由仓库内协议和 controller 负责。 |

_Truncated: showing 12 of 51 matched lines._
...
_Truncated: showing 12 of 38 matched lines._
...
_Truncated: showing 12 of 37 matched lines._
